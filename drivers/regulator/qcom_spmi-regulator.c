...
enum spmi_regulator_subtype {
	...
	SPMI_REGULATOR_SUBTYPE_L440_N300_ST	= 0x42,
	SPMI_REGULATOR_SUBTYPE_L440_N600_ST	= 0x43,
	SPMI_REGULATOR_SUBTYPE_L440_P50		= 0x46,
	SPMI_REGULATOR_SUBTYPE_L440_P150	= 0x47,
	SPMI_REGULATOR_SUBTYPE_L440_P600	= 0x49,
	SPMI_REGULATOR_SUBTYPE_L440_LVP150	= 0x4d,
	SPMI_REGULATOR_SUBTYPE_L440_LVP600	= 0x4f,
...
static struct spmi_voltage_range pldo440_ranges[] = {
	SPMI_VOLTAGE_RANGE(0, 1504000, 1504000, 3544000, 3544000, 8000),
};

static struct spmi_voltage_range nldo440_ranges[] = {
...
static DEFINE_SPMI_SET_POINTS(pldo440);
static DEFINE_SPMI_SET_POINTS(nldo440);
...
static const struct spmi_regulator_mapping supported_regulators[] = {
	...
	SPMI_VREG(LDO, HT_LVP300,    0, INF, FTSMPS426, ftsmps426,
							ht_lvpldo, 10000),
	SPMI_VREG(LDO, L440_N300_ST, 0, INF, FTSMPS426, ftsmps426,
							nldo440,   10000),
	SPMI_VREG(LDO, L440_N600_ST, 0, INF, FTSMPS426, ftsmps426,
							nldo440,   10000),
	SPMI_VREG(LDO, L440_P50,     0, INF, FTSMPS426, ftsmps426,
							pldo440,   10000),
	SPMI_VREG(LDO, L440_P150,    0, INF, FTSMPS426, ftsmps426,
							pldo440,   10000),
	SPMI_VREG(LDO, L440_P600,    0, INF, FTSMPS426, ftsmps426,
							pldo440,   10000),
	SPMI_VREG(LDO, L440_LVP150,  0, INF, FTSMPS426, ftsmps426,
							ht_lvpldo, 10000),
	SPMI_VREG(LDO, L440_LVP600,  0, INF, FTSMPS426, ftsmps426,
							ht_lvpldo, 10000),
...
static const struct of_device_id qcom_spmi_regulator_match[] = {
	...
	{ .compatible = "qcom,pm660-regulators", .data = &pm660_regulstors },

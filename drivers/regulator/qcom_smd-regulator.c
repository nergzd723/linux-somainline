...
static const struct regulator_desc pm660_ftsmps = {
	.linear_ranges = (struct linear_range[]) {
		REGULATOR_LINEAR_RANGE(352000, 0, 250, 4000),
	},
	.n_linear_ranges = 1,
	.n_voltages = 251,
	.ops = &rpm_smps_ldo_ops,
...
static const struct regulator_desc pm660_nldo440 = {
	.linear_ranges = (struct linear_range[]) {
...
static const struct regulator_desc pm660_pldo440 = {
	.linear_ranges = (struct linear_range[]) {
...
static const struct rpm_regulator_data rpm_pm660_regulators[] = {
	...
	{ "l1", QCOM_SMD_RPM_LDOA, 1, &pm660_nldo440, "vdd_l1_l6_l7" },
	{ "l2", QCOM_SMD_RPM_LDOA, 2, &pm660_ht_nldo, "vdd_l2_l3" },
	{ "l3", QCOM_SMD_RPM_LDOA, 3, &pm660_nldo440, "vdd_l2_l3" },
	...
	{ "l15", QCOM_SMD_RPM_LDOA, 15, &pm660_pldo440, "vdd_l15_l16_l17_l18_l19" },
	{ "l16", QCOM_SMD_RPM_LDOA, 16, &pm660_pldo440, "vdd_l15_l16_l17_l18_l19" },
	{ "l17", QCOM_SMD_RPM_LDOA, 17, &pm660_pldo440, "vdd_l15_l16_l17_l18_l19" },
	{ "l18", QCOM_SMD_RPM_LDOA, 18, &pm660_pldo440, "vdd_l15_l16_l17_l18_l19" },
	{ "l19", QCOM_SMD_RPM_LDOA, 19, &pm660_pldo440, "vdd_l15_l16_l17_l18_l19" },
	{ }
};
...
static const struct rpm_regulator_data rpm_pm660l_regulators[] = {
	...
	{ "l1", QCOM_SMD_RPM_LDOB, 1, &pm660_nldo440, "vdd_l1_l9_l10" },
	{ "l2", QCOM_SMD_RPM_LDOB, 2, &pm660_pldo440, "vdd_l2" },
	{ "l3", QCOM_SMD_RPM_LDOB, 3, &pm660_pldo440, "vdd_l3_l5_l7_l8" },
	{ "l4", QCOM_SMD_RPM_LDOB, 4, &pm660_pldo440, "vdd_l4_l6" },
	{ "l5", QCOM_SMD_RPM_LDOB, 5, &pm660_pldo440, "vdd_l3_l5_l7_l8" },
	{ "l6", QCOM_SMD_RPM_LDOB, 6, &pm660_pldo440, "vdd_l4_l6" },
	{ "l7", QCOM_SMD_RPM_LDOB, 7, &pm660_pldo440, "vdd_l3_l5_l7_l8" },
	{ "l8", QCOM_SMD_RPM_LDOB, 8, &pm660_pldo440, "vdd_l3_l5_l7_l8" },

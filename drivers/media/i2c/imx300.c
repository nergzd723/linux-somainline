...
#define IMX300_GROUP_SELECT		0x0104
...
/* Use as 16-bits reg */
#define IMX300_REG_EXCK_FREQ_MHZ	0x0136 /* 0x0136 8-bits on IMX300?? still (Freq << 8) too... */
#define IMX300_EXCK_FREQ_MHZ_MIN	6
#define IMX300_EXCK_FREQ_MHZ_MAX	27
 ...
 * 0x0016 and comparing it to zero: it looks like being dummy, so let's
 * use a value that seems to be consistent between different devices
 * and call it a day.
 * After all, dear developer, if you don't have this camera on your
 * board, you shouldn't be adding it in your DT... :(
 */

/* changed from 004 to 000 */
...
#define IMX300_VTS_MIN			20
#define IMX300_VTS_MAX			(65535 - IMX300_VTS_MIN)	/*max_linecount = 0x1FFD6 (131030) */
...
#define IMX300_REG_ORIENTATION		0x0101 /* I believe... */
...
#define IMX300_REG_TEMPERATURE_EN	0x0138
#define IMX300_REG_TEMPERATURE_VAL	0x013a
...
#define IMX300_DGTL_GAIN_MAX		4096	/* Max = 0xFFF */
...
#define IMX300_REG_BINNING_CTL		0x0901
#define IMX300_REG_BINNING_CAL		0x0902


/*
 * ** IMX300 native and active pixel array size **
 *
 * Being this a multi-aspect sensor, the following
 * native W/H apply:
 * For 4:3  aspect ratio: 5984x4140 (25MP)
 * For 16:9 aspect ratio: 5984x3392 (20.3MP)
 *
 * Keep in mind that the reverse engineered commands are
 * setting the sensor for the 16:9 aspect ratio only and
 * never for 4:3, so here we declare only the first one.
 *
 * P.S: Hey, you, developer! If you know how to configure
 *      this sensor for the 4:3 aspect ratio, please do!
 */
#define IMX300_NATIVE_WIDTH		5980U
#define IMX300_NATIVE_HEIGHT		3392U
#define IMX300_PIXEL_ARRAY_LEFT		0U
#define IMX300_PIXEL_ARRAY_TOP		0U
#define IMX300_PIXEL_ARRAY_WIDTH	5980U
#define IMX300_PIXEL_ARRAY_HEIGHT	3392U
...
static const struct imx300_reg init_sequence[] = {
	{ 0x0136, 0x18, IMX300_REG_VALUE_08BIT },
...
/* Magic registers common for all of the specified resolutions */
static const struct imx300_reg mode_common_regs[] = {
	{ 0x0101, 0x03, IMX300_REG_VALUE_08BIT },
	{ 0x0112, 0x0a, IMX300_REG_VALUE_08BIT },
	{ 0x0113, 0x0a, IMX300_REG_VALUE_08BIT },
	{ 0x0114, 0x03, IMX300_REG_VALUE_08BIT },
...
static const struct imx300_reg binning_mode_off[] = {
	{ 0x0900, 0x00, IMX300_REG_VALUE_08BIT },
	{ 0x0901, 0x11, IMX300_REG_VALUE_08BIT },
	{ 0x0902, 0x00, IMX300_REG_VALUE_08BIT },
...
static const struct imx300_reg binning_mode_2x2[] = {
	{ 0x0900, 0x01, IMX300_REG_VALUE_08BIT },
	{ 0x0901, 0x22, IMX300_REG_VALUE_08BIT },
	{ 0x0902, 0x02, IMX300_REG_VALUE_08BIT },
	{ 0x3a00, 0x19, IMX300_REG_VALUE_08BIT },
...
static int imx300_start_streaming(struct imx300 *imx300)
{
	...
	ret = imx300_update_digital_gain(imx300, 3072);
...
static int imx300_probe(struct i2c_client *client)
{
	...
	/* Due to the really broken sensor id, let's inform about us... */
	dev_info(dev, "Sony Exmor-RS IMX300 camera sensor ready!\n");
...
MODULE_DESCRIPTION("Sony Exmor-RS IMX300 sensor driver");

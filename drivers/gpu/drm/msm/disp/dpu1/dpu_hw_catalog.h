...
#define DPU_HW_VER_320  DPU_HW_VER(3, 2, 0) /* sdm660/636 */
#define DPU_HW_VER_330  DPU_HW_VER(3, 3, 0) /* sdm630 v1.0 */
...
#define IS_SDM630_TARGET(rev) IS_DPU_MAJOR_MINOR_SAME((rev), DPU_HW_VER_330)
#define IS_SDM660_TARGET(rev) IS_DPU_MAJOR_MINOR_SAME((rev), DPU_HW_VER_320)

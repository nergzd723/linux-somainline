...
*/
/* For A508 use different hwcg parameters. This is a50x_hwcg_regs.
            -- this struct needs to be put in a header
               and reused across all Adreno model specific
               implementations. This is a TODO.
*/
static const struct {
	u32 offset;
	u32 value;
